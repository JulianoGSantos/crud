...
<header class="container-fluid border border-1 border-start-0 border-end-0 p-4">
    <div class="row g-2">
        ...
        <div class="col-2">
            <div class="border p-1 rounded-end mb-2">
                <a href="welcome" class="btn btn-sm"><img src="https://cdn0.iconfinder.com/data/icons/ui-essentials-2-3/32/user_interface_ui_basic_app_ui_interface_login_login-256.png" alt="login" width="20%"> Login</a>
            </div>
        </div>
        <div class="col-2">
            <div class="border p-1 rounded-end mb-2">
        ...
        <div class="card-img-overlay">
            <div class="card" style="width: 20rem;">
                <div class="card-body">
                  ...
                  <p class="card-text mt-5">As coisas ficam melhores quando se é um membro da Nike.Tenha acesso exclusivo em primeira mão aos novos lançamentos,inovações, frete grátis, benefícios especiais de aniversário e muito mais.</p>
...
<div class="container-sm w-25 mt-2">
    <div class="row g-2">
        <div class="card text-bg-dark col-6">
